...
//print_r($feedcrobey);
define('YT_API_URL', 'https://gdata.youtube.com/feeds/api/users/thatmumbojumbo/uploads?v=2&max-results=21&start-index=1');
...
{   
  ...
  //   echo '</div>'; 
  // }
  if ($count == $row_pos_1 || $count == $row_pos_2 || $count == $row_pos_3){
